...
class FreeUpdate extends React.Component {
    state = {
        loading: false,
        confirmDirty: false,
        autoCompleteResult: [],
        ...
        return (
            <div>
                <Modal
                    ...
                    title="Title"
                    onOk={this.handleOk}
                    onCancel={this.props.handler_update_close}
                    footer={[
                        <Button key="back" onClick={this.props.handler_update_close}>Return</Button>,
...
export default Form.create({})(FreeUpdate);
